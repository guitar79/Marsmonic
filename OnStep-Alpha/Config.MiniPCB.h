...
// This is your generated configuration file. Here is how to copy it to your OnStep:
// 1. Open the OnStep.ino file in the Arduino IDE.
// 2. Go to the tab with the file named: <b>Config.MiniPCB.h</b>
// 3. Delete everything that is in the file.
// 4. Click the mouse anywhere inside this configuration generator page.
// 5. Press Ctrl-A, then Ctrl-C to copy. Alternatively, click the right button on the mouse,
//    then choose "Select All", followed by "Copy".
// 6. Now paste using Ctrl-V, or choose "Paste" from the mouse right click menu.
// 7. Save the file.
...
// ===
// Axis 1
//   Pulse rate when tracking:   60.0 steps/second
//   Resolution when tracking:   0.250 arc second/step
//   Maximum Slew Rate:          2.17 degree/second
//   Motor speed when slewing:   23.4 RPM
// Axis 2
//   Pulse rate when tracking:   37.8 steps/second
//   Resolution when tracking:   0.397 arc second/step
//   Maximum Slew Rate:          0.55 degree/second
//   Motor speed when slewing:   23.4 RPM
...
#define StepsPerDegreeAxis1        14400.0

// Axis2 is for Dec/Alt
// Calculated as (example for Losmandy G11)
//  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
//  400           * 32          * 1               *  360/360              = 12800
#define StepsPerDegreeAxis2        9066.666666666666
...
#define StepsPerWormRotationAxis1  64000.0
